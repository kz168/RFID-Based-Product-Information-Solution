 ...
 <div class="page">
	<div class="primary-col">
    	<div class="generic">
        	<div class="services">
             	<div class="title">
                	<h1>Furniture and Home Decor Shops</h1>
                </div>
            	<div class="content">
     ...
     <div class="panel">
      ...
      <a href="navana.php"><img src="images/navana.png" width="200" height="200" /></a>
        <h2><a href="navana.php">N a v a n a  - F u r n i t u r e s</a></h2>
      ...
      <a href="otobi.php"><img src="images/otobi.png" width="200" height="200" /></a>
        <h2><a href="otobi.php">O t o b i</a></h2>

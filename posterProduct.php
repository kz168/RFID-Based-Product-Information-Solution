...
$query_exec1=mysqli_query($dbcon,$query1);
if($query_exec1){
  while($row=$query_exec1->fetch_object()){
    $name=$row->name;
...
$query2="SELECT map_data FROM shop_table WHERE id={$shop}";
...
<title>Tap To Know | Poster Product</title>
 ...
 <div class="page">
	<div class="primary-col">
    	<div class="generic">
        	<div class="services">
             	<div class="title">
                	<h1>Tapped Product and Shop Location</h1>
                </div>
            	<div class="content">
     ...
     <div class="panel">
      <div class="title">
        <h2>Below you will find the specifications of the product you tapped on. Scroll below to see the shop location.</h2>
      </div>
      ...
      <img src="<?php echo $picture;?>" width="200" height="200" />
        ...
        <p>Price - BDT <?php echo $price;?>/-</p>
          <form method="post" action="cart.php?action=add&id=<?php echo $pid; ?>">
      ...
      function init() {
        ...
        marker.bindPopup('<b>Go through this door and find your product!</b>').openPopup();

...
<div class="page-wrapper">
 ...
 <div class="page">
	<div class="primary-col">
     ...
     <div class="panel">
      <div class="title">
        <h2>Browse through all the shops selling brand new cosmetics, at Jamuna Future Park </h2>
      </div>
      ...
      <a href="bodyline.php"><img src="images/bodyline.jpg" width="200" height="200" /></a>
        <h2><a href="bodyline.php">B o d y  L i n e  </a></h2>
        <p>BODYline is 1st Authentic Brand Store in Bangladesh. Check out the store for amazing products! </p>
      </div>
      <div class="clearing"></div>
